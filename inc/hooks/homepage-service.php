        ...
        elseif ( 'from-custom' ==  $from_service ){
            ...
            if( null != $bizlight_home_service_customs ) {
                ...
                foreach( $bizlight_home_service_customs as $bizlight_home_service_custom ) {
                    if( 0 != $bizlight_home_service_custom['bizlight-home-service-posts-ids'] ){
...
if ( ! function_exists( 'bizlight_home_service' ) ) :
    ...
    function bizlight_home_service() {
        ...
        $bizlight_home_service_selection_options = $bizlight_customizer_all_values['bizlight-home-service-selection-options'];
        ...
        if( is_array( $bizlight_service_arrays )){
            $bizlight_home_service_number = $bizlight_customizer_all_values['bizlight-home-service-number'];
