 ...
 * @subpackage eVision Base Pro
 * @since bizlight 1.0.0
 */


if ( !class_exists('evisionthemes_update_checker') ):
	
/**
 * A update checker class. 
 * 
 */
class evisionthemes_update_checker {
	...
	public function requestUpdate($queryArgs = array()){
		...
		if ( ($code == 200) && !empty($body) ){
			$themeUpdate = evisionthemes_update::fromJson($body);
...
if ( !class_exists('evisionthemes_update') ):
...
$evisionthemes_update_checker = new evisionthemes_update_checker(
   'bizlight',
   'http://update.evisionthemes.com/bizlight.json'
);
